...
export const gettingStartedAnswer1 = () => (
  <Typography variant="body2">
      Eth Grid is a pure decentralized game built on <a href="https://www.ethereum.org/">Ethereum.</a> With 
      Eth Grid, you can purchase a "plot" of space on the grid. When you purchase a plot, you get to 
      ...
      digital item.
      <br/><br/>
      You can think of Eth Grid as decentralized version of <a href="https://www.reddit.com/r/place/">r/place</a>,
      a unique and fun social game created by Reddit. Eth Grid was inspired by this, but is fundamentally different due
      to the power of blockchain and smart contract technology - no single entity has control of over the grid, it will live on forever on the blockchain.
      Eth Grid is also different because you can upload full images and buy and sell portions of the grid.
  </Typography>
);
...
export const gettingStartedAnswer2 = () => (
  <div>
    <Typography variant="body2">
      There are a few things you'll need to get started with Eth Grid.
    </Typography>
    <ul>
      ...
      <li><Typography variant="body2">Ether, which is the currenct used to run decentralized applications on Ethereum.</Typography></li>
    </ul>
  </div>
);
...
export const gettingStartedAnswer3 = () => (
  <Typography variant="body2">
    In order to use Eth Grid, you will need to install MetaMask.  MetaMask is a browser 
...
export const gettingStartedAnswer4 = () => (
  <Typography variant="body2">
    We built Eth Grid primarily to learn more about Ethereum DApp development.  After finishing it, we
    thought it would be something the Ethereum community would enjoy, so please let us know what you think!
    You can leave feedback on the Eth Grid GitHub repository (LINK TODO).
  </Typography>
);
...
export const gameplayAnswer1 = () => (
  <div>
    <Typography variant="body2">
      ...
      Then, navigate to the home page of Eth Grid and click the purchase button, shown below:
    </Typography>
    ...
    <ol>
      ...
      <li><Typography variant="body2">Position and size the image by dragging it around on the grid.  A heatmap will be displayed to help you find the cheapest locations.</Typography></li>
...
export const gameplayAnswer4 = () => (
  <Typography variant="body2">
    There is a small fee when purchasing a plot through the Eth Grid UI (just 2%).  The UI is provided as a conenvience
    to users, but any user is more than welcome to interact directly with the Eth Grid smart contracts and 
...
export const techDetailsAnswer1 = () => (
  <Typography variant="body2">
    There are a few components involved in Eth Grid.  There is a UI that is built With
...
export const techDetailsAnswer2 = () => (
  <Typography variant="body2">
    Of course! Eth Grid is powered by a single smart contract here, you can see the code directly
