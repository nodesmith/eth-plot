declare module 'web3' {
    ...
    class Web3 {
        ...
        public toUtf8(bytes: string): string;
    }
    ...
    namespace Web3 {
        ...
        interface EthApi {
            ...
            getCoinbase(callback: (err: Error, account: string) => void): void;
        }
...
type shaArg = { t: string, v: any };
declare module 'web3-utils' {
    function soliditySha3(...args: shaArg[]): string;
}
